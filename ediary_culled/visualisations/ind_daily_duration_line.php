<?php   
	...
	$result = mysql_query('SELECT tr1.daydate, sum(tr1.duration) as mins FROM training_records1 tr1 WHERE tr1.student_id='.$id.' AND tr1.class="'.$class.'" GROUP BY tr1.daydate');
	if(!$result) {
		echo mysql_error();
	}
	...
	$Test->drawTitle(60,22,"Total Duration/Day",50,50,50,585);
	$Test->Stroke("ind_daily_duration_line.png");
?>
